SMODS.Consumable {
    ...
    loc_txt = {
        name = 'Rules Card',
        text = {
        [1] = 'Converts all cards in hand to a random suit and rank.',
        [2] = '',
        [3] = '{C:inactive}(With the effect of the RULES CARD, you can only ACT!){}',
        [4] = '{C:inactive}Originates from{} {C:money}DELTARUNE{}'
    }
    },
    cost = 10,
    unlocked = true,
