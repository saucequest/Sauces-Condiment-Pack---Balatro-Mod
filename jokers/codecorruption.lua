SMODS.Joker{ --Code Corruption
    ...
    loc_txt = {
        ...
        ['text'] = {
            ...
            [2] = '{s:0.7}When Blind selected, self-destructs and:',
            [3] = '{}{C:green,s:0.7}3 in 4{} {s:0.7}chance to give a Cursed Joker{}{}',
            [4] = '{s:0.7}If chance fails, create an {}{C:dark_edition,s:0.7}Unnatural {}{s:0.7}Joker{}',
    ...
    calculate = function(self, card, context)
        if context.setting_blind  then
            if true then
                if SMODS.pseudorandom_probability(card, 'group_0_b29b6444', 3, card.ability.extra.odds, 'j_sauce_codecorruption') then
